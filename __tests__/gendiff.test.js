...
test('test JSON', () => {
  expect(gendiff(fullPathTest('before.json'), fullPathTest('after.json'))).toEqual(readTestFile('resultStylish.txt'));
...
test('test YML', () => {
  expect(gendiff(fullPathTest('before.yml'), fullPathTest('after.yml'))).toEqual(readTestFile('resultStylish.txt'));
